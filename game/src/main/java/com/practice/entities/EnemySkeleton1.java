...
public class EnemySkeleton1 extends Entity {
    private String playerChar = "2-Enemy-Skeleton Crusader 1";
    ...
    public EnemySkeleton1(float x, float y) {
        super(x, y);
        loadAnimations();
    }
    ...
    private void loadAnimations() {
        ...
        if (!spritesDir.exists() && !spritesDir.isDirectory()) {
            System.err.println("Enemy Sprite directory not found");
        } else {
